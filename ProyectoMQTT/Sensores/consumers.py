...
class SensoresConsumer(AsyncWebsocketConsumer):
    async def connect(self):
        ...
        while 1:
            ...
            'co2': ProyectoMQTT.mqtt.co2,'lluvia': ProyectoMQTT.weather.precipitacion,
            'velocidadViento': ProyectoMQTT.weather.velocidadViento,'rafagaViento': ProyectoMQTT.weather.rafagaViento,
